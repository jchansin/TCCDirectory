...
export class TccdApiService {
    ...
    public getSkill(x): Promise<any> {
        ...
        return this.http
            ...
            .catch(error =>
                console.log("Erreur dans getSkill", JSON.stringify(error))
            );
    }
    ...
    public getSkillsList(): Promise<any> {
        ...
        return this.http
            ...
            .then(response => response.json() as TccdApiGlobal)
            .catch(error =>
                console.log("Erreur dans getSkillsList", JSON.stringify(error))
            );
    }
    ...
    public getBusiness(x): Promise<any> {
        ...
        return this.http
            ...
            .then(response => response.json() as TccdApiGlobal)
            .catch(error =>
                console.log("Erreur dans getBusiness", JSON.stringify(error))
            );
    }
    ...
    public getAbus(x): Promise<any> {
        ...
        return this.http
            ...
            .then(response => response.json() as TccdApiGlobal)
            .catch(error =>
                console.log("Erreur dans getAbus", JSON.stringify(error))
            );
    }
